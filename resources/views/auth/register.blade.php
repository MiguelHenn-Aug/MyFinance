...
<div class="auth-page">
    <div class="card auth-card">
        <div class="card-header text-center py-4">
            ...
            <p class="mb-0 text-white-75">Registre-se e comece a controlar suas finanças agora mesmo.</p>
        </div>
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group shadow-sm">
                        ...
                        <input type="text" class="form-control border-start-0" id="name" name="name" value="{{ old('name') }}" placeholder="Seu nome" required>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group shadow-sm">
                        <span class="input-group-text bg-white border-end-0"><i class="bi bi-check2-square"></i></span>
                ...
                <div class="mt-3 text-center">
                    <a href="{{ route('login') }}" class="text-primary fw-semibold">Já tenho uma conta</a>
                </div>
            </form>
        </div>
    </div>
